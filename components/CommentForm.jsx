    ...
    <div className="bg-white shadow-lg rounded-lg p-8 pb-12 mb-8">
      ...
      <div className="mt-8">
        <button
          ...
          className="transition duration-500ms ease hover:bg-indigo-900 inline-block bg-pink-600 text-lg rounded-full text-white px-8 py-3 cursor-pointer"
        >
          Post Comment
        </button>

        {showSuccessMessage && (
          <span className="text-xl float-right font-semibold ml-3 text-green-500">
